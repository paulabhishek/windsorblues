@include('includes.header')
    ...
    <div class="col-12  text-light text-center p-5 header"><br><br>
...
<div class="container card my-5" style="background-color: #c4c8e3;">
    <div class="row g-0" >
...
{{--                @dump(asset('storage/' . $object->img_banner))--}}
                <img style="object-fit: fill; width: 278px; height: 140px;" class="img-thumbnail" src="{{ asset('storage/' . $object->img_banner) }}"  alt="news">
            @endisset
        </div>
        <div class="col-md-8 col-lg-9">
            <div class="card-body">
                ...
                <text class="text-primary"> {{date('l' . ', '. 'F j' . ', ' .  'Y', strtotime($object->date))}}</text>
